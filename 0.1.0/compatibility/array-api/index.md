...
| Provider           | Status                                                                                                                                                          |
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| NumPy              | Qualified through its first-class frontend; see [NumPy](https://yaugenst.github.io/advect/0.1.0/compatibility/numpy/index.md) for the minor-to-revision mapping |
| `array-api-strict` | Qualified through `__array_namespace__()` for all three revisions below                                                                                         |
| CuPy               | Built-in single-device compatibility path; see [CuPy](https://yaugenst.github.io/advect/0.1.0/compatibility/cupy/index.md)                                      |
