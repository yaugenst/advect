...
This adapter carries an Advect pullback into [HIPS Autograd](https://github.com/HIPS/autograd) through `autograd.grad`. See the [shared bridge contract](https://yaugenst.github.io/advect/0.1.1/api/interop/#shared-contract) and [host-framework tutorial](https://yaugenst.github.io/advect/0.1.1/tutorials/host-frameworks/index.md) for the boundary around the wrapped call.
