...
[Pytrees](https://yaugenst.github.io/advect/0.1.1/tutorials/gradients/#select-arguments-and-preserve-structure) let transforms preserve nested tuples, lists, dictionaries, and registered application containers while differentiating the arrays inside them. Other values remain part of the structure. Custom classes may [register a node type](https://yaugenst.github.io/advect/0.1.1/api/pytree/#advect.pytree.register_pytree_node) for dynamic transforms; [staged programs](https://yaugenst.github.io/advect/0.1.1/api/staging/index.md) accept the built-in portable container forms rather than arbitrary Python class registrations.
