...
These are explicit differentiable counterparts to [`scipy.ndimage`](https://docs.scipy.org/doc/scipy/reference/ndimage.html). Use the [compatibility table](https://yaugenst.github.io/advect/0.1.1/compatibility/scipy/index.md) for exact dynamic, staged, and serialized coverage.
