...
See [Troubleshooting](https://yaugenst.github.io/advect/0.1.1/tutorials/debugging/#check-a-suspicious-gradient) for a composed gradient check and [Custom primitives](https://yaugenst.github.io/advect/0.1.1/tutorials/primitives/#check-the-promised-capabilities) for the extension-author workflow.
