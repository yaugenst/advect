...
Workflow scheduling, artifact storage, and remote execution belong above the serialized program. Contributor-level ownership and dependency rules live in the [developer guide](https://yaugenst.github.io/advect/0.1.1/development/index.md).
