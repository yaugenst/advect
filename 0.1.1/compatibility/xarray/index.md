...
This integration is dynamic-only. For a reusable staged kernel, stage the raw array function, call it with `field.data`, and restore labels outside the program. Data-dependent coordinates, MultiIndex coordinates, Dask execution, and broad groupby, rolling, or interpolation coverage are outside the current contract.

See [Arrays and Scientific Python](https://yaugenst.github.io/advect/0.1.1/tutorials/scientific-python/#preserve-xarray-labels) for a complete example.
