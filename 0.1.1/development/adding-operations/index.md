...
Use `@advect.primitive` when application or library code needs one closed operation that Advect cannot see through. The [tutorial](https://yaugenst.github.io/advect/0.1.1/tutorials/primitives/index.md) and [API reference](https://yaugenst.github.io/advect/0.1.1/api/primitives/index.md) own the rule signatures and common JVP-first workflow; this page adds the repository-facing boundaries and evidence.
...
Never edit the generated compatibility inventories by hand. The [testing guide](https://yaugenst.github.io/advect/0.1.1/development/testing/index.md) lists the complete gates and suite ownership. Update the hand-written xarray compatibility contract when its container or metadata boundary changes.
