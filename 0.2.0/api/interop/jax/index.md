...
For auxiliary outputs, pass `has_aux=True` to both the bridge and the [`jax.value_and_grad`](https://docs.jax.dev/en/latest/_autosummary/jax.value_and_grad.html) transformation. Only the first result participates in the Advect [VJP](https://yaugenst.github.io/advect/0.2.0/api/transforms/#advect.vjp):
