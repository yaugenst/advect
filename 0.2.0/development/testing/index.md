...
The [operation-authoring guide](https://yaugenst.github.io/advect/0.2.0/development/adding-operations/index.md) explains the exact `InvocationCase`, `RawRuleCase`, `NumpySupportCase`, derivative-role, and lifetime evidence required for a new public form.
...
The native snippet runner is necessary but not sufficient for browser support. When runnable snippets or the playground boundary changes, build the Pyodide wheel and run the browser lane described in the [documentation guide](https://yaugenst.github.io/advect/0.2.0/development/documentation/index.md).
