...
When Advect cannot differentiate a call safely, it raises an error at the offending line instead of returning a plausible but wrong derivative. All exceptions derive from [`AdvectError`](https://yaugenst.github.io/advect/0.2.1/api/errors/#advect.AdvectError). The [troubleshooting guide](https://yaugenst.github.io/advect/0.2.1/tutorials/debugging/index.md) shows how to use [`debug`](https://yaugenst.github.io/advect/0.2.1/api/errors/#advect.debug) and act on the common tracing, numerical, and staging failures.
