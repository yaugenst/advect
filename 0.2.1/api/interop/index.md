...
| -------------------------------------------------------------------------------------- | ------------------ | -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [PyTorch](https://yaugenst.github.io/advect/0.2.1/api/interop/torch/index.md)          | `advect[torch]`    | [`advect.interop.torch.wrap(function)`](https://yaugenst.github.io/advect/0.2.1/api/interop/torch/#advect.interop.torch.wrap)          | Retains and consumes the forward Advect pullback             |
| [JAX](https://yaugenst.github.io/advect/0.2.1/api/interop/jax/index.md)                | `advect[jax]`      | [`advect.interop.jax.wrap(function, ...)`](https://yaugenst.github.io/advect/0.2.1/api/interop/jax/#advect.interop.jax.wrap)           | Executes eagerly or uses callbacks with a JIT/shape contract |
| [HIPS Autograd](https://yaugenst.github.io/advect/0.2.1/api/interop/autograd/index.md) | `advect[autograd]` | [`advect.interop.autograd.wrap(function)`](https://yaugenst.github.io/advect/0.2.1/api/interop/autograd/#advect.interop.autograd.wrap) | Retains the reusable forward Advect linearization            |
...
All three bridges are first-order reverse-mode boundaries. They do not support Advect [staging](https://yaugenst.github.io/advect/0.2.1/api/staging/index.md), host forward mode, or higher derivatives. The adapters handle the frameworks' different complex cotangent conventions, so native host losses over complex outputs receive the gradient convention expected by that host.
