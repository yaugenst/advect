...
The [shared bridge contract](https://yaugenst.github.io/advect/0.2.1/api/interop/#shared-contract) and [host-framework tutorial](https://yaugenst.github.io/advect/0.2.1/tutorials/host-frameworks/index.md) explain what crosses this boundary.
...
For auxiliary outputs, pass `has_aux=True` to both the bridge and the [`jax.value_and_grad`](https://docs.jax.dev/en/latest/_autosummary/jax.value_and_grad.html) transformation. Only the first result participates in the Advect [VJP](https://yaugenst.github.io/advect/0.2.1/api/transforms/#advect.vjp):
