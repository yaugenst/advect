...
[`stage`](https://yaugenst.github.io/advect/0.2.1/api/staging/#advect.stage) compiles one input signature into an immutable, optimized program that can be called repeatedly, differentiated, saved, and loaded. The [staging tutorial](https://yaugenst.github.io/advect/0.2.1/tutorials/staging/index.md) develops the complete workflow.
