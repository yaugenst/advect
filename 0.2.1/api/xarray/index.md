...
This is a structure integration, not an array provider. It supports dynamic transforms and deliberately rejects staging across the labeled-container boundary. See the [xarray compatibility contract](https://yaugenst.github.io/advect/0.2.1/compatibility/xarray/index.md) for the supported boundary.
