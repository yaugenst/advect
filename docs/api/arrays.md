...
explicit construction helpers for direct
tracers and rectangular nested tracer sequences; ordinary NumPy code should
normally use NumPy constructors, including `like=` dispatch. Use
