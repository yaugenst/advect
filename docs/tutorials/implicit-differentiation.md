...
The bundled callbacks accept one NumPy array or scalar and form a first-order
dynamic boundary. A custom traceable callback can support nested dynamic
derivatives when every operation it executes is itself traceable.
