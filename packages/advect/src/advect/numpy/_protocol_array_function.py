...
from advect.numpy._array_functions_extra import register_extra_handlers
...
from advect.numpy._protocol_array_function_fft import register_fft_handlers
from advect.numpy._protocol_array_function_linalg import register_linalg_handlers
from advect.numpy._protocol_array_function_shape import register_shape_handlers
...
def _register_all_handlers(
    ...
    register_extra_handlers(handlers)
